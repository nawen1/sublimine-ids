...
def main() -> int:
    ...
    files = [
        ...
        "src/sublimine/health/__init__.py",
        "src/sublimine/health/health.py",
        "src/sublimine/health/state.py",
        ...
        "src/sublimine/live.py",
        "src/sublimine/feeds/binance_ws.py",
        ...
        "tests/test_engine_guard_transitions.py",
        "tests/test_alignment_gate_blocks_intent.py",
    ]
